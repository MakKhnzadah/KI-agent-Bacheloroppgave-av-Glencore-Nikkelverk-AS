...
export function UploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Wait for progress to complete, then add document
    setTimeout(async () => {
      setIsUploading(false);
      setUploadComplete(true);
      
      try {
        // Add document to context (now async)
        await addDocument({
          title: title,
          fileName: selectedFile.name,
          category: category as any,
          uploadedBy: user?.name || "Ukjent bruker",
          originalContent: "", // Will be auto-generated by service
          revisedContent: "", // Will be auto-generated by service
        });
        
        // Navigate to queue after showing success message
        setTimeout(() => {
          navigate("/queue");
        }, 2000);
      } catch (error) {
    ...
    }, 2200); // Slightly longer than the progress interval
  };
            ...
            <div className="bg-white border border-white px-6">
              <div className="py-6">
                ...
                <div className="border border-[#000000]/20 rounded-lg p-8">
                  ...
                  <p className="text-sm text-[#000000] mb-6">Last opp PDF, Word, Excel eller tekstfiler for AI-analyse</p>
                  ...
                  <p className="text-xs text-[#000000] text-center mb-6">
                    Støttede formater: PDF, Word, Excel, TXT (maks 10MB)
                  </p>
